  ...
  return (
    <>
      ...
      />
        ...
        {menuIcons[menuIcons.length - 1].element}
          </Button>
        </div>
      </div>
...
cart
  ...
  <form className='relative w-full'>
    <input className='p-4 w-full h-16 shadow-md placeholder-gray-500 placeholder:font-bold' type="search" placeholder='برای جستجو...' />
    <AiOutlineSearch size={24} className="absolute top-6 left-4 text-gray-500 " />
  </form>
